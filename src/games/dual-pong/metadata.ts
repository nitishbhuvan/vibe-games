...
export const dualPongMetadata: GameMetadata = {
  ...
  tagline: 'High-speed 2-Player neon table showdown',
  description:
    'Classic arcade pong upgraded with coffee power-ups, paddle curved deflections, speed rallies, and full 1-Player vs AI or 2-Player local battle!',
  instructions: [
